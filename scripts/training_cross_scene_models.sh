...
do
    ...
    do
        ...
        let allnum=$number*3
        baseJobName="--checkpoint ../checkpoint/20_Person_Cross_Scene_5_Fold_"$item"_WinSize_OursMethod/Fold_"$fold"/ --prdDir ../predictions/20_Person_Cross_Scene_5_Fold_"$item"_WinSize_OursMethod/Test_Fold_"$fold"/ --datasetDir ../../Person_20/Cross_Scene_5_Fold_"$item"_WinSize_all_results/Fold_"$fold"/"
